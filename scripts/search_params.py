    ...
    for index in range(sessions):
        ...
        if early_check_round > 0:
            ...
            if (
                ...
                and first_capital < early_min_capital
            ):
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Search LIMBO100k parameter grids"
    )
    ...
    for fraction in fractions:
        ...
        for multiplier in multipliers:
            ...
            print(
                ...
                f"objective={report['objective_rate']}% | "
                f"best={report['best_session']} € | "
                f"avg={report['average_final_capital']} € | "
    ...
    for rank, report in enumerate(reports[:10], start=1):
        ...
        print(
            f"#{rank} | "
            f"fraction={report['risk_fraction']} | "
            f"multiplier={report['multiplier']} | "
            f"objective={report['objective_rate']}% | "
            f"best={report['best_session']} € | "
            f"best_index={report['best_session_index']} | "
            f"avg={report['average_final_capital']} €"
        )
